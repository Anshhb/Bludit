...
class UserModel {
  ...
  final String banner;
  final String uid;
  final bool isAuthenticated;  // TO CHECK WEATHER USER IS GUEST OR NOT
  final int karma;
  ...
  @override
  bool operator == (Object other){              // == (covariant UserModel other)
    if (identical(this, other)) return true;
  
    return other is UserModel &&   // after return ---> other is UserModel &&
      other.name == name &&
